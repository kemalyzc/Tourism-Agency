...
{
	system("CLS");
    printf("\tPRICE LIST\n=============================\n1. LL - Palandoken Turu 1500 TL\n2. JK - Uludag Turu 2250\n3. SK - Kartepe Turu 1750 TL\n4. SHM - Kapadokya - Peri Bacalari Turu 1300 TL\n"
           "5. AND - Konya - Mevlana Turu 1200 TL\n6. BHB - Dogu Karadeniz Turu 1550 TL\n7. AG - Efes Antik Kent 1400 TL\n8. ND - Yalova Termal 1000 TL\n9. RJ - Abant Golu Turu 1250 TL\n10. SI - Dogu Ekspresiyle Kars Seyahati 2500 TL\n");
}
...
void CheckTicket(user *h)
{
    ...
    printf("You have booked %d tickets for a sum total of TL %.2f for tour code %s\n",h->numtick,total,h->place);
}
...
void BookTicket(user *h)
{
    ...
    ShowBrochure();
    float pricelist[]={1500.0,2250.0,1750.0,1300.0,1200.0,1550.0,1400.0,1000.0,1250.0,2500.0};
    fflush(stdin);
...
void CancelTicket(user *h)
{
    ...
    if(flag==0)
    {
        printf("Your ticket has been successfully cancelled\nA refund of TL %.2f for Tour Code %s for %d tickets will soon be made to your original source of purchase\n",h->price,h->place,h->numtick);
        strcpy(h->place,"N/A");
        h->price=0.0;
        h->numtick=0;
        WriteToFile(t);
